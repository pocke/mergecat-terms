...
1. 「本サービス」とは、サービス提供サイトを通じて提供される、「MergeCat」という名称のウェブサービスを意味します。
2. 「サービス提供者」とは、本サービスの提供者を意味します。
3. 「サービス利用者」とは、本サービスの利用者を意味します。
4. 「サービス提供サイト」とは、http://www.mergecat.com/ 以下のウェブサイトを意味します。
...
<!-- TODO
1. サービス提供者によるサービス利用者に関する情報の取り扱いについては、サービス提供者が別途定めるプライバシーポリシー（URL: https://www.mergecat.com/privacy ）の定めによるものとし、サービス利用者は、このプライバシーポリシーに従ってサービス提供者がサービス利用者に関する情報を取り扱うことについて同意するものとします。
-->
